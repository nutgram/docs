...
| `onSuccessfulPayment($callable)`                         | **Generic**  | Handles successful_payment messages.                                                                                                                                              |
...
| `onForumTopicCreated`                                    | **Generic**  | Handles any forum topic created.                                                                                                                                                  |
| `onForumTopicClosed`                                     | **Generic**  | Handles any forum topic closed.                                                                                                                                                   |
| `onForumTopicReopened`                                   | **Generic**  | Handles any forum topic reopened.                                                                                                                                                 |
