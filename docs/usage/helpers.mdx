...
- <Declaration name="directMessagesTopicId()" type="?int">
    The current <code>message.direct_messages_topic.topic_id</code> if available, <code>null</code> otherwise.
  </Declaration>
- <Declaration name="managedBotId()" type="?int">
    The current <code>message.managed_bot_created.bot.id ?? update.managed_bot.bot.id</code> if available, <code>null</code> otherwise.
  </Declaration>
- <Declaration name="guestQueryId()" type="?string">
    The current <code>message.guest_query_id</code> if available, <code>null</code> otherwise.
  </Declaration>
- <Declaration name="receiverUserId()" type="?int">
    The current <code>message.receiver_user.id</code> if available, <code>null</code> otherwise.
  </Declaration>
- <Declaration name="ephemeralMessageId()" type="?int">
    The current <code>message.ephemeral_message_id</code> if available, <code>null</code> otherwise.
  </Declaration>
...
- <Declaration name="checklist" type="?Checklist">
    The current <code>Checklist</code> if available, <code>null</code> otherwise.
  </Declaration>
- <Declaration name="managedBot" type="?User">
    The current <code>message.managed_bot_created.bot ?? update.managed_bot.bot</code> if available, <code>null</code> otherwise.
  </Declaration>

### Utility Methods

- <Declaration name="isCommand" type="?bool">
    True, if the current update is a command.
  </Declaration>
- <Declaration name="isInlineQuery" type="?bool">
    True, if the current update contains an <code>inline_query</code>.
  </Declaration>
- <Declaration name="isCallbackQuery" type="?bool">
    True, if the current update contains a <code>callback_query</code>.
  </Declaration>
- <Declaration name="isPreCheckoutQuery" type="?bool">
    True, if the current update contains a <code>pre_checkout_query</code>.
  </Declaration>
- <Declaration name="isMyChatMember" type="?bool">
    True, if the current <code>ChatMemberUpdated</code> is in the <code>my_chat_member</code>.
  </Declaration>
- <Declaration name="isDirectMessagesTopic" type="bool">
    True, if the current update is a direct messages topic.
  </Declaration>
- <Declaration name="isSuggestedPost" type="bool">
    True, if the current update is a suggested post.
  </Declaration>
